#!/usr/bin/env python3
"""
slack.py — Slack Web API client (bot token) for the JARVAS Slack workspace pane.

Covers what the CrossPCAI ops loop needs: list channels, read a channel,
post a message, and poll for new activity to surface as JARVAS notifications.
