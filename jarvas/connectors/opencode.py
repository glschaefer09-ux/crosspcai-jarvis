...
This is what turns JARVAS from "chat that can run a shell command" into "hand a
real job to a coding agent and get the work back". JARVAS keeps the queue, the
...
class OpenCode:
    ...
    def pty_supported(self) -> bool:
        # Windows has no pty module; a Windows JARVAS reaches OpenCode by
