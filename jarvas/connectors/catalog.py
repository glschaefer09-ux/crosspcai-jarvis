#!/usr/bin/env python3
"""
catalog.py — every connector and option JARVAS offers, in one place.

Each entry declares an honest status, because a list that implies everything
works equally is worse than a short one:

    native     JARVAS speaks this service directly, with code behind it.
...
CATEGORIES = [
    ("core", "Core", "The parts of JARVAS itself"),
...
CONNECTORS = [
    ...
    _e("hermes", "Hermes", "core", "native",
       "Automation daemon and task queue. JARVAS runs it for you.",
    ...
    _e("nodes", "Paired machines", "core", "native",
       "Drive every machine you installed JARVAS on from one window.",
    ...
    _e("slack", "Slack", "messaging", "native",
       "Read channels and post messages from inside JARVAS.",
    ...
    _e("webhook", "Webhook / n8n", "automation", "native",
       ...
       base_url="https://your-n8n/webhook/jarvas",
