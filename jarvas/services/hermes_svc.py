#!/usr/bin/env python3
"""
hermes_svc.py — built-in Hermes automation daemon (`jarvas --service hermes`).

Wire-compatible with the existing CrossPCAI hermes_agent.py so JARVAS can
...
class Task:
    ...
    def __init__(self, description: str, priority: str = "normal"):
        ...
        # Tasks dispatched by JARVAS carry an "[agent-id] " prefix.
